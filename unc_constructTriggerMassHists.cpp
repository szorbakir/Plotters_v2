...
void unc_constructTriggerMassHists()
{
    if (year == "2016")
    {
        if (uncType == "up")
        {
            storageFile = new TFile("triggerMassHists2016_up.root", "RECREATE");
        }
        else
        {
            storageFile = new TFile("triggerMassHists2016_down.root", "RECREATE");
        }
    }
    else if (year == "2017")
    {
        if (uncType == "up")
        {
            storageFile = new TFile("triggerMassHists2017_up.root", "RECREATE");
        }
        else
        {
            storageFile = new TFile("triggerMassHists2017_down.root", "RECREATE");
        }
    }
    else
    {
        if (uncType == "up")
        {
            storageFile = new TFile("triggerMassHists2018_up.root", "RECREATE");
        }
        else
        {
            storageFile = new TFile("triggerMassHists2018_down.root", "RECREATE");
        }
    }
...
void storeTurnOnPoints()
{
    ...
    TString pathToRefMassHist;
    TString PathToMassHist;
    ...
    { //etaCounter - 1
        ...
        { // trgCounter - 1
            ...
            if (uncType == "up")
            {
                ...
                pathToRefMassHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[j] + "/hdjmassUp";
                PathToMassHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[j + 1] + "/hdjmassUp";
            }
            else
            {
                pathToRefMassHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[j] + "/hdjmassDown";
                PathToMassHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[j + 1] + "/hdjmassDown";
            }
            ...
            {
                parameterForFirstRangeValue = 1.6;
                lastRangeValue = 1000;
                maxEta = atoi(eta[i + 1]);
            }
            ...
            {
                // parameterForFirstRangeValue = 3.2;
            ...
            {
                parameterForFirstRangeValue = 2.1;
                lastRangeValue = 3000;
                maxEta = atoi(eta[i + 1]);
            }
            ...
            {
                parameterForFirstRangeValue = 4.2;
                lastRangeValue = 2000;
                maxEta = atoi(eta[i + 1]);
            }
            ...
            {
                parameterForFirstRangeValue = 7.5;
                lastRangeValue = 5500;
                maxEta = atoi(eta[i + 1]);
            }
...
void cutZBHists()
{
    ...
    for (size_t i = 0; i < 5; i++)
    {
        if (uncType == "up")
        {
            pathToHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[0] + "/hdjmassUp";
        }
        else
        {
            pathToHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[0] + "/hdjmassDown";
        }
...
void cutTrgHists()
{
    ...
    { //etaCounter - 1
        ...
        { // trgCounter - 1
            ...
            if (uncType == "up")
            {
                PathToJetTrgMassHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[j + 1] + "/hdjmassUp";
            }
            else
            {
                PathToJetTrgMassHist = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/jt" + jt[j + 1] + "/hdjmassDown";
            }
