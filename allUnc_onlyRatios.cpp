...
TString mcSpectrumFile_down = "datas/2016/MC/newXSEC/cleaned/up/output-MC-2a.root";
TString mcSpectrumFile_up = "datas/2016/MC/newXSEC/cleaned/down/output-MC-2a.root";
// TString mcSpectrumFile = "datas/2017/MC/newXSEC/STD+GEN+JER_INVESTIGATION/NOMINAL/output-MC-2a.root";
// TString mcSpectrumFile_up = "datas/2017/MC/newXSEC/STD+GEN+JER_INVESTIGATION/UP_variation/output-MC-2a.root";
// TString mcSpectrumFile_down = "datas/2017/MC/newXSEC/STD+GEN+JER_INVESTIGATION/DOWN_variation/output-MC-2a.root";

//* Store hist in this file
TFile *storageFile = new TFile("uncHists.root", "RECREATE");

void allUnc_onlyRatios()
{
  ...
  { //etaCounter - 1
    ...
    gPad->RedrawAxis("g");
    c1->SaveAs("pngs/" + year + "_deneme_" + eta[i] + "-" + eta[i + 1] + ".png");
