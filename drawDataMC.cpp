...
TString dataSpectrumFile = "Meeting_Unfolding/test/DATA_unfold_2017/massSpectrums2017_halfbin.root";
// TString dataSpectrumFile = "massSpectrums2018.root";

// Source root for MC
// TString mcSpectrumFile = "datas/2016/MC/newXSEC/new_normalized/output-MC-2a.root";
TString mcSpectrumFile = "Meeting_Unfolding/test/DATA_unfold_2017/output-MC-2a.root";
...
void drawDataMC()
{
  ...
  { //etaCounter - 1
    ...
    // // MC spectrum
    TString pathToMCSpectrum = "Standard/Eta_" + eta[i] + "-" + eta[i + 1] + "/mc/hdjmass_half";
    mcSpectrum[i] = getClonedHist(mcSpectrumFile, pathToMCSpectrum);
    ...
    // ratioHist[i] = (TH1 *)dataSpectrum[i]->Clone("ratioHist");
    ...
    ratioHist[i]->GetXaxis()->SetTitleOffset(4.);
