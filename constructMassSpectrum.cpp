...
TFile *storageFile = new TFile("massSpectrums2016.root", "RECREATE");
// TFile *storageFile = new TFile("massSpectrums2017_fullbin.root", "RECREATE");
// TFile *storageFile = new TFile("massSpectrums2018.root", "RECREATE");
